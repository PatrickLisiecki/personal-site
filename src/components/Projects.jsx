...
const projectsData = [
    {
        title: "Word Lab",
        description: "Word Lab is a study assistant for expanding language vocabulary with randomly generated games.",
...
export default function Projects() {
    return (
        <section className="flex items-center py-[115px] dark:bg-dark/90 dark:text-white lg:min-h-screen" id="projects">

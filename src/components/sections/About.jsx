        ...
        >
            <div className="container mx-auto">
                ...
                <p className="font-[16px] text-neutral-light-secondary dark:text-neutral-dark-secondary">
                    ...
                    contributing to both the frontend and backend of a project. When I'm not working on a project or
                    schoolwork, you can find me at the gym, watching movies, or playing basketball. At this moment, my
                    favorite movie is Parasite and my favorite show of all time is Breaking Bad. Moreover, I find
                    enjoyment in assembling and fixing computers, which led me to choose computer science as my major.
